<template>
  <div class="dengji">
  	     <div class="left">
  	  	     <div> <img src="../assets/img/daiban.png"><br>待办事项 </div>
  	  	     <div> <img src="../assets/img/yiban.png"><br>已办事项 </div>
  	     </div>
			...
			<div class="biao">
				<el-table ref="multipleTable" :data="tableData3" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
					...
					<el-table-column label="申请单位" width="244">
						<template slot-scope="scope">{{ scope.row.name }}</template>
					</el-table-column>
					<el-table-column prop="fuchi" label="扶持类别" width="150">
					</el-table-column>
					<el-table-column prop="nei" label="资助内容" width="220" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="xiang" label="项目情况" width="220" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="sheng" label="申请金额" width="140" show-overflow-tooltip>
					</el-table-column>
					<el-table-column prop="shifou" label="是否已提交" width="100" show-overflow-tooltip>
					</el-table-column>

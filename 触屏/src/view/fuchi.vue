		...
		<div class="right">
			<div class="section_top">
				...
				<div class="top3">
					...
					<!--弹出层插件 -新增-->
					<!--  <el-popover ref="popover5" placement="top" width="420" v-model="visible2">-->
					<el-dialog title="" :visible.sync="visible2" class="box1" >

						<!--弹框内容-->
						<div class="popvers">
							<div class="popvers_top">
								<img src="../assets/img/jia.png" />
								<h3>新增</h3>
							</div>
							<div class="nav">
								<div :class="{active:type=='a'}" @click="page('a')">项目登记管理</div>
							</div>
							<div class="tabe1" v-if="type=='a'">
								...
								<div id="a1">
									<p id="p1">组织机构：</p>
									<p id="p2">
										<el-autocomplete popper-class="my-autocomplete" v-model="state4" :fetch-suggestions="querySearch2" placeholder="请输入内容" @select="handleSelect2">
											<i class="el-icon-edit el-input__icon" slot="suffix" @click="handleIconClick2">
                                             </i>
											<template slot-scope="props">
												<div class="name">{{ props.item.value }}</div>
												<span class="addr">{{ props.item.address }}</span>
								...
								<div id="a6">
									<p id="p6_1">
										<span>备注：</span><br>
										<span class="span2">(最多只能输<br>入<a>250</a>个字)</span>
									</p>
									<p id="p6_2">
					...
					<!--弹出层插件 -查看-->
					<el-dialog title="" :visible.sync="visible3" class="box2" >
					...
					<!--按钮-->
					    <!--<el-button type="success" v-popover:popover5> <img src="../assets/img/xin.png" />新增</el-button>-->			
					    <el-button type="success"  @click="visible2 = true"> <img src="../assets/img/xin.png"/>新增</el-button>
						...
						<el-button type="success"  @click="visible3 = true"><img src="../assets/img/cha.png">查看</el-button>
	...
	export default {
		...
		methods: {
			...
			querySearch2(queryString, cb) {
				...
				var results2 = queryString ? restaurants2.filter(this.createFilter2(queryString)) : restaurants2;
				// 调用 callback 返回建议列表的数据
				cb(results2);
			},

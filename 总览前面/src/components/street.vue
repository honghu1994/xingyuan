<template>
  <div>
    ...
    <div class="top01">
      ...
      <!-- 盒子点击事件 -->
      <button @click="toCompany()">查看</button>
    </div>
    <div class="left">
      <!-- 资产总览 -->
    ...
    getmap() {
      this.$axios
        ...
        .then(res => {
          ...
          var streetCenter= [
            {
                "assistant_name": "南头办事处",
                "latitude": "22.542197",
                "org_name": "南头街道办",
                "org_code": "D440305101",
                "longitude": "113.923496"
            },
            {
                "assistant_name": "南山办事处",
                "latitude": "22.53084",
                "org_name": "南山街道办",
                "org_code": "D440305102",
                "longitude": "113.927518"
            },
            {
                "assistant_name": "西丽办事处",
                "latitude": "22.585642",
                "org_name": "西丽街道办",
                "org_code": "D440305103",
                "longitude": "113.959204"
            },
            {
                "assistant_name": "沙河办事处",
                "latitude": "22.542751",
                "org_name": "沙河街道办",
                "org_code": "D440305104",
                "longitude": "113.985793"
            },
            {
                "assistant_name": "蛇口办事处",
                "latitude": "22.493842",
                "org_name": "蛇口街道办",
                "org_code": "D440305105",
                "longitude": "113.933828"
            },
            {
                "assistant_name": "招商办事处",
                "latitude": "22.503488",
                "org_name": "招商街道办",
                "org_code": "D440305106",
                "longitude": "113.938604"
            },
            {
                "assistant_name": "粤海办事处",
                "latitude": "22.519486",
                "org_name": "粤海街道办",
                "org_code": "D440305107",
                "longitude": "113.934575"
            },
            {
                "assistant_name": "桃园办事处",
                "latitude": "22.594915",
                "org_name": "桃源街道办",
                "org_code": "D440305108",
                "longitude": "113.971153"
            }
        ]
         let CenterPoint01 = streetCenter.filter(
          ...
          map.centerAndZoom(point, 14); // 初始化地图，设置中心点坐标和地图级别 // 初始化地图,设置中心点坐标和地图级别

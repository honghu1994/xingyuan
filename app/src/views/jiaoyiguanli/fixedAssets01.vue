        ...
        <div class="tabe1" >
          ...
          <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
            <van-list v-model="loading" :finished="finished" finished-text="没有更多了" @load="onLoad">      
              <div class="fixedAssets-content" v-for="(item,index) in tradedAssetsList" :key="index" @click="goTradedAssets(item.assets_id)">
...
export default {
  data() {
    return {
        companyData:[],
        activeName: 'first',
        subordinate:this.$store.state.loginInfo.sessionVal.organization_id,
        value: '',

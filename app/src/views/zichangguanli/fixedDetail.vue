      ...
      <van-tabs v-model="activeName" class='zsmyvant' title-active-color='#6f77fe' color='#6f77fe'>
        ...
        <van-tab title="其他信息" name="b" class="zsfont">
            ...
            <div class="content">
                ...
                <p class="otherborder">
                    <span >房产所有权证号:</span>
                    {{mydata.real_estate_warrant_number}}
                </p>
                <p class="otherborder">
                    <span >房产所有人:</span>
                     {{mydata.property_owner}}
                ...
                <p class="otherborder">
                    <span >土地所有权证号:</span>
                     {{mydata.land_title_certificate_number}}
                ...
                <p class="otherborder">
                    <span >建筑结构:</span>
                     {{mydata.building_structure}}

                   
                </p>
                <p class="otherborder">
                    <span >计量单位:</span>
                     {{mydata.unit_measurement}}
